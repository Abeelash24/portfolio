/*=========================
   SCORPION / CREATURE CURSOR
   (extracted + adapted from scorpion-cursor)
   Global site cursor: transparent, non-blocking, follows pointer.
=========================*/
...
cursorcursorCanvas.width = window.innerWidth;
cursorcursorCanvas.height = window.innerHeight;
cursorcursorCanvas.style.position = "fixed";
cursorcursorCanvas.style.left = "0px";
cursorcursorCanvas.style.top = "0px";
cursorcursorCanvas.style.pointerEvents = "none";
cursorcursorCanvas.style.zIndex = "9999";

function sizeCursorCanvas() {
    cursorCanvas.width = window.innerWidth;
    cursorCanvas.height = window.innerHeight;
}
window.addEventListener("resize", sizeCursorCanvas);
...
class Segment {
    ...
    draw(iter) {
        cursorCtx.beginPath();
        cursorCtx.moveTo(this.parent.x, this.parent.y);
        cursorCtx.lineTo(this.x, this.y);
        cursorCtx.stroke();
        if (iter) {
            for (var i = 0; i < this.children.length; i++) {
...
cursorCtx.strokeStyle = "rgba(0, 247, 255, 0.85)";
...
function setupTentacle() {
    ...
    setInterval(function () {
        cursorCtx.clearRect(0, 0, cursorCanvas.width, cursorCanvas.height);
        critter.follow(cursorCanvas.width / 2, cursorCanvas.height / 2);
        cursorCtx.beginPath();
        cursorCtx.arc(Input.mouse.x, Input.mouse.y, 2, 0, 6.283);
        cursorCtx.fill();
    }, 33);
}
